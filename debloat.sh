...
pm uninstall -k --user 0 com.miui.mediaeditor
pm uninstall -k --user 0 com.miui.mediaviewer
...
pm uninstall -k --user 0 com.miui.voiceassistoverlay
...
pm uninstall -k --user 0 com.xiaomi.gnss.polaris
